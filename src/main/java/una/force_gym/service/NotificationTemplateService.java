...
public class NotificationTemplateService {
    ...
    public Map<String, Object> getNotificationTemplates(
        ...
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("prGetNotificationTemplate", NotificationTemplateDTO.class);
        ...
        List<NotificationTemplateDTO> products = query.getResultList();
        Integer totalRecords = (Integer) query.getOutputParameterValue("p_totalRecords");

        // Mapear respuesta
        Map<String, Object> responseData = new HashMap<>();
        responseData.put("notificationTemplates", products);
